...
bicycle. Automatic roll stabilization of single track vehicles began in earnest
after predictive motorcycle models were developed and refined in throughout the
1970s. \Citet{vanZytveld1975} was influenced by Whipple's work and seems to be
the first \todo{Check if a Japanese researcher was first} to attempt to
...
the vehicle. It was not until the mid 1980s that Ruijs and Pacjecka
successfully demonstrated an automatically balanced
...
that can stabilize a single track vehicle above a minimum speed when not
...
of these robotic bicycles and motorcycles designers did not intend for a human
...
the balance assist but researchers with a similar vehicle recently showed rider
disatisfction with the stabilization~\cite{Hanakam2023}.
