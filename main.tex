...
\begin{figure}
  \centering
  \includegraphics{figures/balance-assist-controllers-eig-vs-speeds.png}
  \caption{Uncontrolled and controlled root locus of eigenvalue components
    plotted versus speed.}
...
\begin{figure}
  ...
  \subcaptionbox{}{\includegraphics[width=70mm]{example-image-a}}
  %\subcaptionbox{Diagram of perturbation system.}{\includegraphics[width=70mm]{figures/setup-diagram.png}
  \subcaptionbox{Diagram of perturbation system.}{\includegraphics[width=70mm]{example-image-b}
}
\end{figure}
