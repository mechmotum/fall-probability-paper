...
work and seems to be the first \todo{Check if a Japanese researcher was first}
...
demonstrating what his theoretic control model correctly predicted. In his
...
\begin{figure}
  \includegraphics[width=\textwidth]{figures/perturbation_0.png}
