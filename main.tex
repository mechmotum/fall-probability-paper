...
\begin{itemize}
  \item A bicycle steering motor with automatic roll rate feedback control can
    stabilize the bicycle-rider system at speeds as low as 8~\si{\kph}.
  ...
  \item Balance assist technology could reduce natural single-actor falls
    around the limits of the rider's control authority.
\end{itemize}
