...
concerned with wobble instabilities, somethign not prominent in bicycles at low
...
similar vehicle recently showed rider disatisfction with the
...
\begin{table}
  ...
  \caption{Logistic regression coefficient estimates at
    6~\unit{\kilo\meter\per\hour} and gain $k=10$. Multiplicative change in
...
\begin{table}
  \centering
  \caption{Logistic regression coefficient estimates at
    10~\unit{\kilo\meter\per\hour} and gain $k=8$.  Multiplicative change in
