...
It is important to understand the relationship between probability and odds to
relate Figure~\ref{fig:probability} and Table~\ref{tab:freq-coeffs-6}.  How
much the probability that a fall changes depends on the values of all predictor
variables and we visualize only one view into the results here. If the odds
