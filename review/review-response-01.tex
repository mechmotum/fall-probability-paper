...
\usepackage{csquotes}
\signname{Jason K. Moore, PhD\\Assistant Professor, BioMechanical
...
\begin{displayquote}
  Reviewer \#1: This paper describe attempt to reduce probability of falls by
  providing electro-mechanical assistance to bicycles, which generally become
  unstable at very low speeds. Using an electric bicycle with an assist motor
  attached to the steering axis as the test vehicle, we first conducted
...
we had to stop the treadmill because it is not possible to recover
...
\begin{displayquote}
  Reviewer \#2: This paper investigates the effectiveness of an automatic
  balance-assist system designed to reduce falls at low speeds. The core
  hypothesis is that a bicycle stabilized by an automatically controlled
