...
The participants experienced the same magnitude perturbations more than once
throughout the warm-up, the perturbation threshold determination, and the
adaptive staircase procedure. But they did not experience the same force
repeatedly many times in order to gain familiarity. We would have liked to
remove the learning effect by letting the participants train for a long
duration, but this was not practical. We choose to include a measure of
learning in the statistics as an alternative. We have now noted this in Section
2.4.
...
Each participant experienced an equal number of clockwise and counterclockwise
perturbations. So 10 clockwise, 10 counterclockwise for both balance-assist on
and off, making 40 perturbations in total. Within the 20 perturbations of each
of the balance-assist states, the order of the directions was randomized.

In the analysis we normalized the time series measurements to the sign of the
perturbation as well as included the configuration at the time of perturbation
as independent variables. A variable could be included to indicate if a
perturbation was preceded by the same sign perturbation or not, but we have
chosen not to include this, as it was not in our original hypothesis. We added
text to clarify these things in Section 2.5.
